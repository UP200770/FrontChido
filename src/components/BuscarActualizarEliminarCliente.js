...
const BuscarActualizarEliminarCliente = () => {
  ...
  <div className="card bg-dark text-white">
    ...
    <div className="card-body">
      <div className="mb-3">
        ...
        <input type="text" className="form-control bg-secondary text-white" value={idCliente} onChange={handleIdClienteChange} />
        ...
        <div>
          ...
          <form>
            <div className="mb-3">
              ...
              <input type="text" className="form-control bg-secondary text-white" value={nombre} onChange={e => setNombre(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="apellidoPaterno" className="form-label">Apellido Paterno:</label>
              <input type="text" className="form-control bg-secondary text-white" value={apellidoPaterno} onChange={e => setApellidoPaterno(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="apellidoMaterno" className="form-label">Apellido Materno:</label>
              <input type="text" className="form-control bg-secondary text-white" value={apellidoMaterno} onChange={e => setApellidoMaterno(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="genero" className="form-label">Género:</label>
              <input type="text" className="form-control bg-secondary text-white" value={genero} onChange={e => setGenero(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="direccion" className="form-label">Dirección:</label>
              <input type="text" className="form-control bg-secondary text-white" value={direccion} onChange={e => setDireccion(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="telefono" className="form-label">Teléfono:</label>
              <input type="text" className="form-control bg-secondary text-white" value={telefono} onChange={e => setTelefono(e.target.value)} />
            </div>
            <div className="mb-3">
              <label htmlFor="email" className="form-label">Email:</label>
              <input type="text" className="form-control bg-secondary text-white" value={email} onChange={e => setEmail(e.target.value)} />
            </div>
...
export default BuscarActualizarEliminarCliente