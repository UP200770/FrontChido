  ...
  return (
    ...
    <div className="card bg-dark text-white">
      <div className="card-header bg-primary">
        <h2 className="text-center">Buscar, Actualizar o Eliminar Constructora</h2>
      </div>
      <div className="card-body">
        <div className="mb-3">
          <label htmlFor="id_constructora" className="form-label">ID de la Constructora:</label>
          <input type="text" className="form-control bg-secondary text-white" value={id_constructora} onChange={handleId_constructoraChange} />
          ...
          <div>
            ...
            <form>
              <div className="mb-3">
                ...
                <input type="text" className="form-control bg-secondary text-white" value={razon_social} onChange={e => setRazon_social(e.target.value)} />
              </div>
              <div className="mb-3">
                <label htmlFor="representante" className="form-label">Representante:</label>
                <input type="text" className="form-control bg-secondary text-white" value={representante} onChange={e => setRepresentante(e.target.value)} />
              </div>
              <div className="mb-3">
                <label htmlFor="contacto" className="form-label">Contacto:</label>
                <input type="text" className="form-control bg-secondary text-white" value={contacto} onChange={e => setContacto(e.target.value)} />
              </div>
              <div className="mb-3">
                <label htmlFor="estado" className="form-label">Estado:</label>
                <input type="text" className="form-control bg-secondary text-white" value={estado} onChange={e => setEstado(e.target.value)} />
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control bg-secondary text-white" value={codigo_postal} onChange={e => setCodigo_postal(e.target.value)} />
              </div>
