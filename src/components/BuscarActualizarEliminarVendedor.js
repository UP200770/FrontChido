    ...
    <div className="card bg-dark text-white">
      ...
      <div className="card-body">
        <div className="mb-3">
          ...
          <input type="text" className="form-control bg-secondary text-white" value={idVendedor} onChange={handleIdVendedorChange} />
          ...
          <div>
            ...
            <form>
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control bg-secondary text-white" value={rfc} onChange={e => setRFC(e.target.value)} />
              </div>
              <div className="mb-3">
